...
public class TaxCode
{
    ...
    /// </summary>
    public bool IsTaxable => TaxTreatment == TaxTreatment.Standard;

    /// <summary>
    /// Determines if this is zero-rated (0% but still in GST system)
    /// </summary>
    public bool IsZeroRated => TaxTreatment == TaxTreatment.ZeroRated;

    /// <summary>
    /// Determines if this is exempt from GST/HST
    /// </summary>
    public bool IsExempt => TaxTreatment == TaxTreatment.Exempt;
