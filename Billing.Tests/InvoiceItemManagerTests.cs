...
namespace Billing.Tests
{
    public class InvoiceItemManagerTests
    {
        ...
        private readonly InvoiceItemManager _invoiceItemManager;
        private readonly Guid _validItemId = Guid.NewGuid();
        private readonly DateOnly _testDate = new DateOnly(2023, 1, 1);
        ...
        public InvoiceItemManagerTests()
        {
            ...
            _invoiceItemManager = new InvoiceItemManager(
                _mockItemRepository.Object,
                new List<IInvoiceItemFactory> { _mockItemFactory.Object }
            );
        }
        ...
        {
            // Act
            var result = _invoiceItemManager.Create(_validItemId, _testDate, _testQuantity);
        ...
        public void Create_WithInvalidItemId_ThrowsArgumentException()
        {
            ...
            var exception = Assert.Throws<ArgumentException>(() => 
                _invoiceItemManager.Create(invalidItemId, _testDate, _testQuantity));
        ...
        public void Create_WithNoMatchingFactory_ThrowsInvalidOperationException()
        {
            ...
            var exception = Assert.Throws<InvalidOperationException>(() => 
                _invoiceItemManager.Create(itemId, _testDate, _testQuantity));
        ...
        public void Create_WithValidInputs_SetsQuantityCorrectly()
        {
            ...
            // Act
            var result = _invoiceItemManager.Create(_validItemId, _testDate, expectedQuantity);
        ...
        public void Create_WithMultipleFactories_SelectsCorrectFactory()
        {
            ...
            var manager = new InvoiceItemManager(
                _mockItemRepository.Object,
                new List<IInvoiceItemFactory> { mockFactory1.Object, mockFactory2.Object }
            );
