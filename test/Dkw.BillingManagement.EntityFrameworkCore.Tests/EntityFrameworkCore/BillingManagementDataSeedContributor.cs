    ...
    : IDataSeedContributor, ITransientDependency
{
    ...
    public async Task SeedAsync(DataSeedContext context)
    {
        using (_currentTenant.Change(context?.TenantId))
        {
            ...
            var customer = TestData.Customer(province, TestData.DefaultCustomerId);
            ...
            var taxableService = Service.Create(TestData.TaxableServiceId, "Taxable Service", "A service that is taxable.", "STD-PROF", ItemCategory.FinancialServices).AddPrice(200.00m, _date);
